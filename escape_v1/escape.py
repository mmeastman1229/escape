...
objects = {
    ...
    19: [
        images.pipes3, images.pipes3_shadow,
        "Pipes for the life support systems"
    ],
    20: [
        images.door,
...
def use_object():
    ...
    standard_responses = {
        ...
        56: ">> MESSAGE: It's a bit too fiddly. "
            "Can you thread it on something",
        59: ">> MESSAGE: You need to fix the leak "
            "before you can use the canister",
...
##############################################################################
##   DOORS   #
# Special functions for working with door
###############################################################################
