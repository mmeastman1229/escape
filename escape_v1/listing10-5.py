...
def examine_object():
    ...
    if item_player_is_on in [0, 2]:  # Don't describe the floor
        return
    description = f'>> EXAMINE: "You see {objects[item_player_is_on][2]}"'
...
def use_object():
    ...
    standard_responses = {
       ...
       32: f'>> MESSAGE: "It shakes and rumbles,'
           'but nothing else happens" ',
       34: f'>> MESSAGE: "Ah! That\'s better.'
           'Now wash your hands" ',
       35: f'>> MESSAGE: "You wash your hands and shake the water off" ',
       37: f'>> MESSAGE: "The test tubes smoke slightly'
           'as you shake them" ',
