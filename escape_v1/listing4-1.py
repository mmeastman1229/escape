...
GAME_MAP += [
    ["The airlock", 13, 5, True, False],  # Room 27
    ["The engineering lab", 13, 13, False, False],  # Room 26
    ["Poodle Mission Control", 9, 13, False, False],  # Room 28
    ["The viewing gallery", 5, 5, False, False],  # Room 29
    ...
    ["PLAYER_NAME" + "'s sleepig quarters", 9, 11, False, False],  # Room 36
...
def draw():
    ...
    for y in range(room_height):
        for x in range(room_width):
            ...
            screen.blit(image_to_draw, 0.(top_left_x + (x * 30),
