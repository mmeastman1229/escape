...
objects = {
    ...
    8: [
     ...
     55: [images.yoyo, None, "A toy made of fine, strong string and plastic."
          "Used for antigrav experiments.", f"{PLAYER_NAME}'s yoyo"],
     ...
     79: [images.access_card, None,
          f"This access card belongs to {PLAYER_NAME}", "an access card"],
     80: [images.access_card, None,
          f"This access card belongs to {FRIEND1_NAME}", "an access card"],
     81: [images.access_card, None,
          f"This access card belongs to {FRIEND2_NAME}", "an access card"],
}
...
scenery = {
    ...
    35: [[16, 2, 9], [16, 2, 2], [16, 3, 3], [16, 3, 8], [16, 8, 9],
         [16, 8, 2], [16, 1, 8],
    ...
    47: [[9, 1, 1], [9, 1, 2], [10, 1, 3], [12, 1, 7], [5, 4, 4], [6, 4, 7],
         [4, 1, 8]],
    48: [[17, 4, 1], [17, 4, 2], [17, 4, 3], [17, 4, 4], [17, 4, 5],
         [17, 4, 6], [17, 4, 7], [17, 8, 1], [17, 8, 2], [17, 8, 3],
         [17, 8, 4], [17, 8, 5], [17, 8, 6], [17, 8, 7], [14, 1, 1]],
