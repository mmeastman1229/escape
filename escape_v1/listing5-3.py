planets = {
    ...
    "Neptune": ["An ice giant farthest from the sun", True, 14],
    "Pluto": ["Largest dwarf planet in the Solary System", False, 5],
}
...
while True:
    ...
    Summary: {planets[query][0]}
    Planets has rings: {planets[query][1]}
    Moons: {query} has {planets[query][2]} moon(s)""")
    else:
