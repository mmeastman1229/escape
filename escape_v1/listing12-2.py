...
in_my_pockets = [55]
selected_item = 1  # the first item
item_carrying = in_my_pockets[selected_item]
...
def draw_energy_air():
    ...
    screen.draw.text("AIR", (20, 755), color=BLUE)
    screen.draw.text("ENERGY", (180, 766), color=YELLOW)

    if air > 0:
        box = Rect((50, 756), (air, 20))
...
def end_the_game(reason):
    ...
    screen.draw.text(
        "GAME OVER", (120, 400), color="white", fontsize=128, shadow=(1, 1), color=BLACK
    )
