...
LANDOR_SECTOR = random.randint(1, 24)
LANDOR_X = random.randint(2, 11)
LANDOR_Y = random.randint(2, 11)
...
objects = {
    ...
    22: [
        images.door,
        images.door_shadow,
        "A locked door. It needs " f"{PLAYER_NAME}'s access card",
    ],
    23: [
        images.door,
        images.door_shadow,
        "A locked door. It needs " f"{FRIEND1_NAME}'s access card",
    ],
    24: [
        images.door,
        images.door_shadow,
        "A locked door. It needs " f"{FRIEND2_NAME}'s access card",
    ],
    25: [
        images.door,
        images.door_shadow,
    ...
    27: [
        ...
        f"{LANDOR_SECTOR}  // X: {LANDOR_X}  // Y: {LANDOR_Y}",
    ],
    28: [
        images.rock_large,
...
assert check_counter == 166, "Expected 161 scenery items"
...
def generate_map():
    ...
    global room_map, room_width, room_height, room_name, hazard_map, room_exit_top, room_exit_right
...
def draw():
    global room_height, room_width, room_map, room_name, room_exit_right, room_exit_top
    generate_map()
    screen.clear()
    # room_map[2][4] = 7
    # room_map[2][6] = 48
